  ...
  Details of the latest version can be found on the Git repository
  on the page under https://github.com/kelleryvo/CineBoost.

  Documentation
  -------------

  The documentation available as of the date of this release is
  included in Word format in the docs/ directory. The most
